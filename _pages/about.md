...
<section>
  ...
  <p>I'm Amidu Dabor, a results-driven Software Engineer and AI/Machine Learning specialist. I build intelligent, scalable, and ethically aligned systems that solve real-world problems. I recently completed my Master of Science in Information Systems and Technology (Software Engineering focus) at United States International University - Africa, where I specialized in large-scale software engineering.

With over 2 years of multidisciplinary experience spanning telecommunications and IT education, complemented by 2+ years of hands-on professional projects and specialized trainings in backend software development, intelligent agentic systems, and applied machine learning, I bring a strong track record of designing and deploying high-impact, data-driven solutions. My technical toolkit includes Python, JavaScript, SQL, TensorFlow, Keras, Scikit-learn, Django, Flask, FastAPI, and deployment across platforms like GCP, AWS, Azure, Modal, Gradio, and Weights & Biases. I excel in full-stack development (backend-focused), machine learning operations, and transforming complex datasets into actionable insights, always focused on delivering measurable business value through innovation and collaboration, bringing a rare blend of strong software engineering, data-centric thinking, and the ability to work independently with little or no supervision.
  </p>
